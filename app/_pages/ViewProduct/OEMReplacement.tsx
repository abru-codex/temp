...
const OEMReplacement = ({ products }: any) => {
  return (
    <div className="px-3 my-10">
      <SectionTittle tittle1={"OEM"} tittle2={"Replacement Parts"} />

      {/* control product card according to column and grid */}

      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-3 my-8">
