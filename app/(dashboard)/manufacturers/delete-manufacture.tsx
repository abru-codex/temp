import { deleteManufactureById } from "@/app/_apicalls/manufactures";
...
const DeleteManufacture = () => {
  ...
  const { deleteManufacture, getManufactures } = useManufacturesStore();
  ...
  return (
    <>
      <Transition appear show={searchParam.has("deleteManuId")} as={Fragment}>
                ...
                <Dialog.Panel className=" rounded-xl    border-danger border-2 dark:border-slate-700 bg-white dark:bg-black ">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      onClick={async () => {
                        deleteManufacture(
                          searchParam.get("deleteManuId") as any
                        );
                        closeModal();
                        const message = await deleteManufactureById(
                          searchParam.get("deleteManuId")!,
                          //@ts-ignore
